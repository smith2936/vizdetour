...
'''This example shows a various types of Glyphs that are offered by bokeh library.
...
curdoc().add_root(gridplot(children, ncols=4, width=200, height=200))  # open a browser